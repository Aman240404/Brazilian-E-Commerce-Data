...
# Load dataset
all_df = pd.read_csv(r'C:\Users\HP\Desktop\Project\Data-Analytics-Brazilian-Ecommerce\data\all_data.csv')all_df["order_purchase_timestamp"] = pd.to_datetime(all_df["order_purchase_timestamp"])
